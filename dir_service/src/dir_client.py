...
from errors import NotAttached, Unauthorized, ConnectionError, ObjectNotFound, UnexpectedError
from constants import ROOT, DEFAULT_ENCODING, DIR_CHILDS, DIR_PARENT_ID, DIR_IDENTIFIER, FILES

from authService import header_name, Administrator, User
...
class DirectoryService:
    ...
    def get_directory(self, dir_id, user):
        ...
        if not isinstance(user, (Administrator, User)):
