...
from constants import ADMIN, ADMIN_TOKEN, USER_TOKEN, DEFAULT_DIR_SERVICE_PORT,\
    ROOT, DIR_IDENTIFIER, DIR_CHILDS, DIR_PARENT_ID, DEFAULT_DIR_DB, HTTPS_DEBUG_MODE, URL, FILES
from errors import Unauthorized, ObjectNotFound, AlreadyDoneError

from authService import AuthService

from dir_service import DirectoryDB
...
class DirectoryService:
    ...
    def __init__(self, db_file, auth_service,
        ...
        self._auth_ = AuthService(auth_service)
